...
If you do add any of the extra credit options, be sure to add/modify these test
cases as appropriate to account for your module's added functionality.
"""
...
def testPairings():
    ...
    possible_pairs = set([
        frozenset([id1, id3]), frozenset([id1, id5]),
